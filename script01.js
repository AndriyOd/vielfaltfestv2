    ...
    onSnapshot(query(collection(db, "guests"), orderBy("createdAt", "asc")), (snapshot) => {
        ...
        guests.forEach((g, index) => {
            ...
            if (isNewGuestAdded && index === guests.length - 1) {
                ...
                //countryText.classList.toggle("wCountry-2");
                ...
                /*
                const willkommenEl = document.getElementById("willkommen");
                willkommenEl.classList.toggle("willkommen-2");
                countryText.classList.toggle("wCountry-2");
                flying.classList.toggle("test-flag-2");
                */
                ...
                //willkommenEl.style.visibility = "visible";
                //countryText.style.visibility = "visible";
                    ...
                    requestAnimationFrame(() => {
                        requestAnimationFrame(() => {
                            ...
                            */
                            ...
                            frameEl.style.visibility = "hidden";
                            //willkommenEl.style.visibility = "hidden";
                            //countryText.style.visibility = "hidden";
